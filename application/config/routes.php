...
$route['get_district_by_id/(:num)'] = 'registration/getDistrictById/$1';
$route['get_upazila_by_id/(:num)'] = 'registration/getUpazilaById/$1';
$route['get_board_list'] = 'registration/getBoardList';
